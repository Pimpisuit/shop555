...
<body>
	...
	<form action="php-editCart.php" method="post">
		...
		จำนวนที่สั่งไปแล้ว : <input type="text" name="old-amount" value="<?php echo $old ?>" readonly> <br>
		<!-- ตำแหน่งของสินค้า --><input type="hidden" name="index" value="<?php echo $id ?>">
		จำนวนที่จะแก้ไข : <input type="text" name="new-amount"> <br>
